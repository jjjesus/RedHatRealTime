...
\begin{table}[H]
    ...
    \hline
        \textbf{Feature} & \textbf{Used in KRFS} & \textbf{Description} \\
    \hline
Kernel Preemption & (Yes,built-in) & Though Kernel Preemption is listed as a Concurrent RedHawk feature, it obviously is sourced from the RT Patch (and now the Linux mainline, see Appendix A). \\[4.5mm]
