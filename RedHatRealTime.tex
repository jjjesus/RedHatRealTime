...
\begin{table}[H]
    ...
    \hline
        \textbf{Feature} & \textbf{Used in KRFS} & \textbf{Description} \\
    \hline
Kernel Preemption & (Yes,built-in) & Though Kernel Preemption is listed as a
Concurrent RedHawk feature, it obviously is sourced from the RT Patch (and now
the Linux mainline, see Appendix A). \\[4.5mm]
...
Low Latency Enhancements & (Yes,built-in) & Some kernel tuning derived from Red
Hat's TUNA and SuSE Linux tools have been added as default. \\[4.5mm]
Priority Inheritance & (Yes,built-in) & This has been part of SuSE Linux and the
RT Patch since 2007.  \\[4.5mm]
...
available for the Linux kernel since 2001.%
\\
    \hline
    \end{tabular}%
    }
