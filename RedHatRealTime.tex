...
server (like Jenkins) can install his own copy of the kernel source code or
kernel development tools and build his own copy of the kernel, BSP, and device
drivers (Figure \ref{fig:red_hat_dev}.  The Red Hat LiveMedia Creator package
can be used for creating the target Linux filesystem and the PXE boot tools.
