...
Note that the Concurrent RedHawk product offering has not changed in the fifteen
years since the product announcement above except to continue to merge in RT
Patch improvements and to continually improve their NightStar tool suite.
