...
The original patch was originally named \emph{PREMPT\_RT} or \emph{CONFIG\_PREEMPT\_RT} and authored by some of the most important Linux kernel developers ever, Ingo Molnar and Thomas Gleixner of Red Hat and Paul McKenny of IBM.
...
\begin{enumerate}
    ...
    \item Support for a Real-Time Clock and Interrupt Module (RCIM) - a PCI card that provided programmable timers and 12 input and output external interrupt lines to synchronize clocks across system.  SuSE provided Linux device drivers for this card.
