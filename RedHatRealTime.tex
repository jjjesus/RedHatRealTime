...
outside access; requiring a password for login is a basic hardening mechanism.
...
scripts to apply the STIG remedies, DevSecOps tools based on Ansible produced by
the founders of the Ansible team (now part of Red Hat) will automatically harden
the operating system as part of the DevSecOps build-deploy process.
