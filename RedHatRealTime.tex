...
\subsubsection{Sample STIG XML record}
...
\begin{lstlisting}[caption={STIG record \emph{title}},
...
\begin{adjustwidth}{0.5in}{0.0in}
\begin{lstlisting}[caption={STIG record \emph{rule} and \emph{severity}},
label={lst:stig_xml_rule}]
...
\begin{adjustwidth}{0.5in}{0.0in}
\begin{lstlisting}[caption={STIG record \emph{fixtext}},
label={lst:stig_xml_fixtext}]
...
\begin{adjustwidth}{0.5in}{0.0in}
\begin{lstlisting}[caption={STIG record \emph{check-content}},
