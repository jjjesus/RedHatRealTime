...
\begin{table}[H]
    ...
    \hline
        \textbf{Feature} & \textbf{Used} & \textbf{Description} \\
    \hline
...
%Red Hawk:
%\$281,000 a year covers quarterly maintenance updates
%\$300 each for perpetual run times per instance

%\footnote{Source for Red Hawk costs: Karl Weis, Global Supply Chain Program Lead, Raytheon}
%\footnote{Source for Red Hat Real-Time costs: Lynn Bonenfant, IT Program Lead, Raytheon}

%Red Hat:
%\$400 yearly run time/maintenance fee per instance

%Development
%NE \$20,796.00 per year for 2 users
%TX \$20,796.00 per year for 2 users


%Red Hat Real-Time yearly per instance
%\$2,703.54
