...
Real-Time Scheduler & (Yes,built-in) & Alternatives to the Linux default Completely Fair Scheduler (CFS) like SCHED\_FIFO (deadline-based) and SCHED\_RR (round-robin) have been part of the RT Patch since 2007. \\[4.5mm]
...
Table \ref{tab:license_costs} summarizes license costs.\footnote{Source for license costs are from References \ref{ref:karl} and \ref{ref:lynn}.}
