...
\subsubsection{PXE Install Boot with RedHawk in K2}

\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.7\textwidth]{img/pxe_install}
...
\subsubsection{Initial ramdisk image}
